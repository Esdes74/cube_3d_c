...
/*   Updated: 2023/12/06 19:19:23 by eslamber         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// 	while (1)
// 	{
// 		if (col->dist_tot_x == 0 && ((col->dist_tot_y == 0 &&  		col->dist_tot_x + col->dist_x <= col->dist_tot_y + col->dist_y) ||  		(col->dist_tot_y != 0 &&  		col->dist_tot_x + col->dist_x <= col->dist_tot_y + col->delta_y))) // Travail sur x
// 		{
...
// 		}
// 		else if (col->dist_tot_y == 0 && ((col->dist_tot_x == 0 &&  		col->dist_tot_x + col->dist_x > col->dist_tot_y + col->dist_y) ||  		(col->dist_tot_x != 0 && 		col->dist_tot_x + col->delta_x > col->dist_tot_y + col->dist_y))) // Travail sur y
// 		{
...
// 		}
// 		else if (col->dist_tot_x != 0 && ((col->dist_tot_y == 0 &&  		col->dist_tot_x + col->delta_x <= col->dist_tot_y + col->dist_y) ||  		(col->dist_tot_y != 0 &&  		col->dist_tot_x + col->delta_x <= col->dist_tot_y + col->delta_y)))
// 		{
// 			col->pos_x_dx -= 1;
...
// 		}
// 		else if (col->dist_tot_y != 0 && ((col->dist_tot_x == 0 &&  		col->dist_tot_x + col->dist_x > col->dist_tot_y + col->delta_y) ||  		(col->dist_tot_x != 0 &&  		col->dist_tot_x + col->delta_x > col->dist_tot_y + col->delta_y)))
// 		{
...
// 	x1 = (((YARD * WIN_H) + WALL) +  	sqrt(pow(YARD * WIN_H, 2) + ((WALL * 2) * YARD * WIN_H) + pow(WALL, 2))) /  	(2 * WIN_H);
// 	x2 = (((YARD * WIN_H) + WALL) -  	sqrt(pow(YARD * WIN_H, 2) + ((WALL * 2) * YARD * WIN_H) + pow(WALL, 2))) /  	(2 * WIN_H);
// 	return (fmax(x1, x2));
// }
...
// 	ray->dist = sin(fabs(ray->begin_corner - ray->corner_col));
// 	dis.wall = ((ray->dist_max - ray->dist) * WIN_H) / ray->dist_max;
// 	// printf("dist = %f\n", sin(fabs(ray->begin_corner - ray->corner_col)) * ray->dist);
// 	h = 0;
// 	while (h < WIN_H)
// 	{
